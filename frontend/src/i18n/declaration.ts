...
export enum I18nKey {
  ...
  GIT$AZURE_DEVOPS_CONNECTED_TO = "GIT$AZURE_DEVOPS_CONNECTED_TO",
  ...
  ORG$NO_MEMBERS = "ORG$NO_MEMBERS",
  ORG$LOADING_MEMBERS = "ORG$LOADING_MEMBERS",
  ORG$NO_ORG_FOUND = "ORG$NO_ORG_FOUND",
  ORG$UPDATED = "ORG$UPDATED",
  ORG$UPDATE_FAILED = "ORG$UPDATE_FAILED",
  ORG$ROLE_UPDATED = "ORG$ROLE_UPDATED",
  ORG$ROLE_UPDATE_FAILED = "ORG$ROLE_UPDATE_FAILED",
  ORG$MEMBER_ADDED = "ORG$MEMBER_ADDED",
  ORG$ADD_MEMBER_FAILED = "ORG$ADD_MEMBER_FAILED",
  ORG$MEMBER_REMOVED = "ORG$MEMBER_REMOVED",
  ORG$REMOVE_MEMBER_FAILED = "ORG$REMOVE_MEMBER_FAILED",
  ORG$USER_ID = "ORG$USER_ID",
  ORG$ENTER_USER_ID = "ORG$ENTER_USER_ID",
  ORG$ROLE = "ORG$ROLE",
  ORG$ROLE_ADMIN = "ORG$ROLE_ADMIN",
  ORG$ROLE_MEMBER = "ORG$ROLE_MEMBER",
  ORG$ADDING = "ORG$ADDING",
  ORG$USER = "ORG$USER",
  ...
  SETTINGS$API_VERSION = "SETTINGS$API_VERSION",
  ...
  SETTINGS$LLM_ADMIN_ONLY = "SETTINGS$LLM_ADMIN_ONLY",
  SETTINGS$LLM_ADMIN_ORG_NOTICE = "SETTINGS$LLM_ADMIN_ORG_NOTICE",
  SETTINGS$NAV_WEBHOOKS = "SETTINGS$NAV_WEBHOOKS",
  WEBHOOKS$NO_CONFIGS = "WEBHOOKS$NO_CONFIGS",
  WEBHOOKS$ADD_CONFIG = "WEBHOOKS$ADD_CONFIG",
  WEBHOOKS$REPOSITORY_URL = "WEBHOOKS$REPOSITORY_URL",
  WEBHOOKS$PROJECT_NAME = "WEBHOOKS$PROJECT_NAME",
  WEBHOOKS$ENABLED = "WEBHOOKS$ENABLED",
  WEBHOOKS$ADD_RULE = "WEBHOOKS$ADD_RULE",
  WEBHOOKS$NO_RULES = "WEBHOOKS$NO_RULES",
  WEBHOOKS$EVENT_TYPE = "WEBHOOKS$EVENT_TYPE",
  WEBHOOKS$ACTION = "WEBHOOKS$ACTION",
  WEBHOOKS$PRIORITY = "WEBHOOKS$PRIORITY",
  WEBHOOKS$CONDITIONS = "WEBHOOKS$CONDITIONS",
  WEBHOOKS$TEST = "WEBHOOKS$TEST",
  WEBHOOKS$CONFIG_CREATED = "WEBHOOKS$CONFIG_CREATED",
  WEBHOOKS$CONFIG_DELETED = "WEBHOOKS$CONFIG_DELETED",
  WEBHOOKS$RULE_CREATED = "WEBHOOKS$RULE_CREATED",
  WEBHOOKS$RULE_DELETED = "WEBHOOKS$RULE_DELETED",
  WEBHOOKS$TEST_RESULT = "WEBHOOKS$TEST_RESULT",
  WEBHOOKS$ADMIN_ONLY = "WEBHOOKS$ADMIN_ONLY",
  WEBHOOKS$RULES = "WEBHOOKS$RULES",
  WEBHOOKS$RULE_COUNT = "WEBHOOKS$RULE_COUNT",
  WEBHOOKS$DELETE = "WEBHOOKS$DELETE",
  WEBHOOKS$DISABLE = "WEBHOOKS$DISABLE",
  WEBHOOKS$ENABLE = "WEBHOOKS$ENABLE",
  WEBHOOKS$PRIORITY_LABEL = "WEBHOOKS$PRIORITY_LABEL",
  WEBHOOKS$TRIGGER = "WEBHOOKS$TRIGGER",
  WEBHOOKS$IGNORE = "WEBHOOKS$IGNORE",
  ...
  SETTINGS$USER_EMAIL_PLACEHOLDER = "SETTINGS$USER_EMAIL_PLACEHOLDER",
  ...
  INVITE$REQUEST_INVITE = "INVITE$REQUEST_INVITE",
  INVITE$REQUEST_SUBMITTED = "INVITE$REQUEST_SUBMITTED",
  INVITE$THANK_YOU_MESSAGE = "INVITE$THANK_YOU_MESSAGE",
  INVITE$RETURN_TO_LOGIN = "INVITE$RETURN_TO_LOGIN",
  INVITE$ENTER_EMAIL_MESSAGE = "INVITE$ENTER_EMAIL_MESSAGE",
  INVITE$EMAIL_ADDRESS = "INVITE$EMAIL_ADDRESS",
  INVITE$ADDITIONAL_INFO = "INVITE$ADDITIONAL_INFO",
  INVITE$SUBMIT_REQUEST = "INVITE$SUBMIT_REQUEST",
  INVITE$SUBMITTING = "INVITE$SUBMITTING",
  INVITE$ALREADY_HAVE_ACCESS = "INVITE$ALREADY_HAVE_ACCESS",
  INVITE$NO_ACCESS_REQUEST = "INVITE$NO_ACCESS_REQUEST",
  INVITE$MANAGEMENT_TITLE = "INVITE$MANAGEMENT_TITLE",
  INVITE$MANAGEMENT_DESCRIPTION = "INVITE$MANAGEMENT_DESCRIPTION",
  INVITE$NO_REQUESTS_FOUND = "INVITE$NO_REQUESTS_FOUND",
}
